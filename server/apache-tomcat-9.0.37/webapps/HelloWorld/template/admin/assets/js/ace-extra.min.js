"ace" in window || (window.ace = {}), ace.config = {
    ...
    (1 == a || a === b) && "localStorage" in window && null !== window.localStorage ? (d = ace.storage, e = 1) : null == d && (2 == a || a === b) && "cookie" in document && null !== document.cookie && (d = ace.cookie, e = 2), this.set = function (a, b, f, g, h) {
        if (d) if (f === h) f = b, b = a, null == f ? d.remove(c + b) : 1 == e ? d.set(c + b, f) : 2 == e && d.set(c + b, f, ace.config.cookie_expiry, g || ace.config.cookie_path); else if (1 == e) null == f ? d.remove(c + a + "_" + b) : d.set(c + a + "_" + b, f); else if (2 == e) {
            var i = d.get(c + a), j = i ? JSON.parse(i) : {};
            if (null == f) {
        ...
        if (2 == e) {
            var g = d.get(c + a), h = g ? JSON.parse(g) : {};
